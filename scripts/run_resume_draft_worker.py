...
PROVIDER_SCRIPTS = {
    "codex": "scripts/write_resume_with_codex.py",
    "claude": "scripts/write_resume_with_claude.py",
}
...
def main() -> int:
    ...
    run = store.transition(run_id, "resume_draft_running", "resume_draft_worker")
    try:
        ...
        store.transition(run_id, "resume_draft_completed", "resume_draft_worker",
        ...
        store.transition(run_id, "resume_draft_failed", "resume_draft_worker",
