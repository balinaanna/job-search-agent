...
LinkedIn, Indeed, Eluta, and ZipRecruiter job pages. It reads the visible posting,
refuses incomplete captures, and sends complete postings into the local discovery
queue. It does not crawl search results or capture pages without your click.
