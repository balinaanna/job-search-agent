...
export function DecisionButtons({ leadId }: { leadId: string }) {
  ...
  if (status === "cover_letter_pdf_completed") return <div className="decision-saved pursue"><strong>Application documents ready</strong><span>Resume and cover-letter PDFs are approved. Nothing has been submitted.</span></div>;
