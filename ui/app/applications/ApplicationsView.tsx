...
export function ApplicationsView(){
  ...
  useEffect(()=>{void load();const changed=()=>void load();window.addEventListener("jobs-changed",changed);const timer=window.setInterval(load,3000);return()=>{window.removeEventListener("jobs-changed",changed);window.clearInterval(timer);};},[load]);
