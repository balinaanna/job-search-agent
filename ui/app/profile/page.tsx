...
export default function CareerProfilePage(){
  return <main className="app-shell profile-page-shell">
    ...
    <section className="workspace profile-workspace"><MasterResume/><JobPreferences/><ProfileManager/><footer>Verified career evidence · Profile changes never apply without explicit approval.</footer></section>
  </main>;
}
